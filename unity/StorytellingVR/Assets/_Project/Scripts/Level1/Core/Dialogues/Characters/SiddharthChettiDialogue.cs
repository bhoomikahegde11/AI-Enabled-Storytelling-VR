    ...
    public static CharacterDialogueSet Create()
    {
        return new CharacterDialogueSet(
            ...
            new List<DialogueLine>
            {
                ...
                {
                    "Greetings, merchant. Siddharth Chetti seeks {quantityLabel} of {spiceName} for the bazaar trade.",
                    "I am Siddharth Chetti, and I have come for {quantityLabel} of {spiceName} to fill my shop jars.",
                    ...
                    "Siddharth Chetti is here for {quantityLabel} of {spiceName}. Let us see what your stall offers."
                }, "siddharth_chetti"),
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.High, NpcDesperationBucket.Medium, RoundBucket.Middle, NpcPersonalityBucket.Friendly),
                new DialogueLine(DialogueScenario.SellerPriceTooHigh, new[]
                {
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.Medium, NpcDesperationBucket.Medium, RoundBucket.Middle, NpcPersonalityBucket.Friendly),
                new DialogueLine(DialogueScenario.SellerPriceTooHigh, new[]
                {
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.Low, NpcDesperationBucket.Medium, RoundBucket.Middle, NpcPersonalityBucket.Friendly),
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.High, NpcDesperationBucket.Medium, RoundBucket.Final, NpcPersonalityBucket.Friendly),
                new DialogueLine(DialogueScenario.BuyerCounterFinal, new[]
                {
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.Medium, NpcDesperationBucket.Medium, RoundBucket.Final, NpcPersonalityBucket.Friendly),
                new DialogueLine(DialogueScenario.BuyerCounterFinal, new[]
                {
                ...
                }, "siddharth_chetti", PlayerReputationBucket.Neutral, NpcPatienceBucket.Low, NpcDesperationBucket.Medium, RoundBucket.Final, NpcPersonalityBucket.Friendly),
